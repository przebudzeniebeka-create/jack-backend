# main.py — FastAPI backend for JackQS (pełny, bez cięć)
# - CORE: z pliku lokalnego / R2 / ENV
# - Detekcja języka PL/EN + uprzejma odpowiedź
# - Solid CORS
# - /api/turnstile/verify (twarda weryfikacja na backendzie; obsługuje TURNSTILE_SECRET lub TURNSTILE_SECRET_KEY)
...
# Akceptuj obie nazwy: TURNSTILE_SECRET i TURNSTILE_SECRET_KEY
...
def friendly_fallback(user_text: str, preferred_lang: Optional[str] = None) -> str:
    """
    Jeśli chcesz, by pierwsze przywitanie BYŁO WYŁĄCZNIE po EN,
    wywołaj /api/chat z {"message":"...", "lang":"en"}.
    Potem, po wykryciu PL w wypowiedzi użytkownika, UI może przełączyć się na 'pl'.
    """
